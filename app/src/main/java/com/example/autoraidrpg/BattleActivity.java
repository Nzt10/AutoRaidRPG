...
import com.example.autoraidrpg.controller.BattleController;

public class BattleActivity extends AppCompatActivity implements IView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new BattleController(this).init();
    }
