...
public class RoleDAO {
    ...
    public static long store(SQLiteOpenHelper dbHelper, Role role) {
        ...
        cv.put(RoleDAO.NAME, role.getName());
        return db.insert(RoleDAO.TABLE, null, cv);
    }
    ...
    public static Role retrieve(SQLiteOpenHelper dbHelper, int roleID) {
        ...
        Cursor cursor = db.query(RoleDAO.TABLE, projection, selection, selectionArgs, null, null, null);
    ...
    public static List<Role> all(SQLiteOpenHelper dbHelper) {
        ...
        String[] projection = { "*" };
        Cursor cursor = db.query(RoleDAO.TABLE, projection, null, null, null, null, null);
